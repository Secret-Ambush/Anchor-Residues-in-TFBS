...
def ref_seq(col_index):
    input_file_path = f'/Users/bristi/Desktop/Design Project/Working-with-TF/TFs UniProbe Data/GATA4/GATA4_anti-GST_8mers_top_enrichment.txt'
...
def sequence_logo_generator(file_path, col_index):
    ...
    with open(f'MonomerBinding/SeqLogos/GATA4_{col_index}.png', 'wb') as fout:
        fout.write(png_bytes)

# running for both complement and regular
for col_index in [0,1]:
    input_file_path = f'/Users/bristi/Desktop/Design Project/Working-with-TF/TFs UniProbe Data/GATA4/GATA4_anti-GST_8mers_11111111.txt'
    output_file_path = f'/Users/bristi/Desktop/Design Project/Working-with-TF/MonomerBinding/aligned_GATA4_col_{col_index}.txt'
